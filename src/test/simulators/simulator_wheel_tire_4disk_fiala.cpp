...
Simulator_Wheel_Tire_4Disk_Fiala::Simulator_Wheel_Tire_4Disk_Fiala(double t_start, double t_end, double t_step) {
	m_steps         = 0;
	m_t_start       = t_start;
	m_t_end         = t_end;
	m_t_step        = t_step;
...
void Simulator_Wheel_Tire_4Disk_Fiala::run () {
	io::CSVReader<52> m_inputs("wheel_tire_test_result/Wheel_Tire_4Disk_inputs10101445.csv"); 
