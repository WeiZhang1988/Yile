...
Simulator_Tir_4Fiala::Simulator_Tir_4Fiala(double t_start, double t_end, double t_step) {
    ...
    shared_ptr<Tire_Fiala> sptr_tir_fl = make_shared<Tire_Fiala>("data/tir_fiala_par_0.json");
	shared_ptr<Tire_Fiala> sptr_tir_fr = make_shared<Tire_Fiala>("data/tir_fiala_par_0.json");
	shared_ptr<Tire_Fiala> sptr_tir_rl = make_shared<Tire_Fiala>("data/tir_fiala_par_0.json");
	shared_ptr<Tire_Fiala> sptr_tir_rr = make_shared<Tire_Fiala>("data/tir_fiala_par_0.json");
