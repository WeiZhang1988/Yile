...
void NMSPC::Sys_Whl_4Disk::update_pv() {
	interface.map_sub_whl_4disk_pv();
	m_sptr_subsys_whl_4disk->update_pv(interface.m_sub_whl_4disk_pv_inputs,interface.m_sub_whl_4disk_pv_outputs);
}

void NMSPC::Sys_Whl_4Disk::update_fm() {
	interface.map_sub_whl_4disk_fm();
	m_sptr_subsys_whl_4disk->update_fm(interface.m_sub_whl_4disk_fm_inputs,interface.m_sub_whl_4disk_fm_outputs);
}
