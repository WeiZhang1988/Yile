...
public:
	...
	Subsys_Sus_2Ind (double F0z_f=2886.0, double Kz_f=52451.006579283188, double Cz_f=5565.224638019838, \
	...
	double F0z_r=2907.0, double Kz_r=52451.006579283188, double Cz_r=5565.224638019838, \
    ...
    void push_pv (
	double &Sus_str_fl, double &Sus_gamma_fl, double &Sus_caster_fl, double &Sus_r_fl, double &Sus_vx_fl, double &Sus_vy_fl, double &Sus_vz_fl, \
	...
	void pull_fm_o (
	const double &Sus_TirFx_fl, const double &Sus_TirFy_fl, const double &Tir_Mx_fl, const double &Tir_My_fl, const double &Tir_Mz_fl, \
	...
	void push_fm_o (
	double &Sus_VehFx_fl, double &Sus_VehFy_fl, double &Sus_VehMx_fl, double &Sus_VehMy_fl, double &Sus_VehMz_fl, \
	...
	const double &Sus_TirFx_rr, const double &Sus_TirFy_rr, const double &Tir_Mx_rr, const double &Tir_My_rr, const double &Tir_Mz_rr);
	void push_fm (
	double &Sus_VehFx_fl, double &Sus_VehFy_fl, double &Sus_VehFz_fl, double &Sus_VehMx_fl, double &Sus_VehMy_fl, double &Sus_VehMz_fl, double &Sus_Fz_fl, \
