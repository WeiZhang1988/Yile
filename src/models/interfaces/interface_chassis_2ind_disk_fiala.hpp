...
public:
    ...
    double m_Int_Pz_fl     = NaN;           //vehicle body to suspension; origin: m_xe_z_fl
    double m_Int_Vz_fl     = NaN;           //vehicle body to suspension; origin: m_ve_z_fl
    ...
    double m_Int_Pz_fr     = NaN;           //vehicle body to suspension; origin: m_xe_z_fr
    double m_Int_Vz_fr     = NaN;           //vehicle body to suspension; origin: m_ve_z_fr
    ...
    double m_Int_Pz_rl     = NaN;           //vehicle body to suspension; origin: m_xe_z_rl
    double m_Int_Vz_rl     = NaN;           //vehicle body to suspension; origin: m_ve_z_rl
    ...
    double m_Int_Pz_rr     = NaN;           //vehicle body to suspension; origin: m_xe_z_rr
    double m_Int_Vz_rr     = NaN;           //vehicle body to suspension; origin: m_ve_z_rr
    ...
    double m_xb_z_fl = NaN;           //not consumed
    ...
    double m_xb_z_fr = NaN;           //not consumed
    ...
    double m_xb_z_rl = NaN;           //not consumed
    ...
    double m_xb_z_rr = NaN;           //not consumed
    //vb fm push nothing
