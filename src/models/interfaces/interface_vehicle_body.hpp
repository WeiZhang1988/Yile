...
public:
    ...
    double m_Int_Pz_fl = NaN;         //to suspension; origin: m_xe_z_fl
    double m_ve_x_fl = NaN;           //not consumed
    double m_ve_y_fl = NaN;           //not consumed
    double m_Int_Vz_fl = NaN;         //to suspension; origin: m_ve_z_fl
    ...
    double m_Int_Pz_fr = NaN;         //to suspension; origin: m_xe_z_fr
    double m_ve_x_fr = NaN;           //not consumed
    double m_ve_y_fr = NaN;           //not consumed
    double m_Int_Vz_fr = NaN;         //to suspension; origin: m_ve_z_fr
    ...
    double m_Int_Pz_rl = NaN;         //to suspension; origin: m_xe_z_rl
    double m_ve_x_rl = NaN;           //not consumed
    double m_ve_y_rl = NaN;           //not consumed
    double m_Int_Vz_rl = NaN;         //to suspension; origin: m_ve_z_rl
    ...
    double m_Int_Pz_rr = NaN;         //to suspension; origin: m_xe_z_rr
    double m_ve_x_rr = NaN;           //not consumed
    double m_ve_y_rr = NaN;           //not consumed
    double m_Int_Vz_rr = NaN;         //to suspension; origin: m_ve_z_rr
